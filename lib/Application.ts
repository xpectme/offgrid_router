...
import { Router, ViewEngine } from "../deps.ts";
...
export class Application<State extends { [key: string]: unknown } = any>
  extends Router {
  ...
  #logger: ApplicationLogger = console;
  log: (...args: unknown[]) => void;
  info: (...args: unknown[]) => void;
  warn: (...args: unknown[]) => void;
  error: (...args: unknown[]) => void;
  ...
  setLogger(logger: ApplicationLogger) {
    this.#logger = logger;
  }
